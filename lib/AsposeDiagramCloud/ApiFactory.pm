...
#
package AsposeDiagramCloud::ApiFactory;
...
usesub AsposeDiagramCloud::Object;

use AsposeDiagramCloud::ApiClient;

=head1 Name

	AsposeDiagramCloud::ApiFactory - constructs APIs to retrieve AsposeDiagramCloud objects
...
=head1 Synopsis
	...
	my $api_factory = AsposeDiagramCloud::ApiFactory->new( ... ); # any args for ApiClient constructor
							  
	# later...
	my $pet_api = $api_factory->get_api('Pet');  
	
	# $pet_api isa AsposeDiagramCloud::PetApi
...
my %_apis = map { $_ =~ /^AsposeDiagramCloud::(.*)$/; $1 => $_ } 
			grep {$_ =~ /Api$/} 
			usesub 'AsposeDiagramCloud';

=head1 new($api_client)
	
	create a new AsposeDiagramCloud::ApiFactory instance with the given AsposeDiagramCloud::ApiClient instance.

=head1 new(%parameters)

	Any parameters are optional, and are passed to and stored on the api_client object.
	
	See L<AsposeDiagramCloud::ApiClient> and L<AsposeDiagramCloud::Configuration> for valid parameters
