...
#
package AsposeDiagramCloud::ApiClient;
...
sub new {
    ...
    my $config;
    if ( $_[0] && ref $_[0] && ref $_[0] eq 'AsposeDiagramCloud::Configuration' ) {
        $config = $_[0];
    } else {
        $config = AsposeDiagramCloud::Configuration->new(@_);
    }
...
sub deserialize
{
    ...
    if (not defined $data) {
        ...
        my $_instance = use_module("AsposeDiagramCloud::Object::$class")->new;
        if (ref $data eq "HASH") {
