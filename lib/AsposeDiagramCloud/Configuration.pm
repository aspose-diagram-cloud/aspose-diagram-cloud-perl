...
#
package AsposeDiagramCloud::Configuration;
...
use constant VERSION => '18.10';

=head1 Name

        AsposeDiagramCloud::Configuration - holds the configuration for all AsposeDiagramCloud Modules
...
default: Swagger-Codegen/18.10/perl
...
sub new {
	...
	$p{http_timeout} //= 180;
	$p{http_user_agent} //= 'Swagger-Codegen/18.10/perl';
