...
has _cfg => ( is => 'ro',
              isa => 'AsposeDiagramCloud::Configuration',
              default => sub { AsposeDiagramCloud::Configuration->new() },
              );

has version_info => ( is => 'ro',
                      isa => 'HashRef',
                      default => sub { {
                          app_name => 'Aspose.Diagram Cloud API Reference',
                          app_version => '3.0',
...
sub _build_af {
	...
	return AsposeDiagramCloud::ApiFactory->new(%args);
}

=head1 NAME

AsposeDiagramCloud::Role - a Moose role for the Aspose.Diagram Cloud API Reference

=head2 Aspose.Diagram Cloud API Reference version: 3.0
